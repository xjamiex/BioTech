...
public class AndoriPlanetGenerator extends PlanetGenerator{
    public float heightScl = 0.8f, octaves = 8, persistence = 0.7f, heightPow = 3f, heightMult = 1.6f;

    //TODO inline/remove
    public static float arkThresh = 0.28f, arkScl = 0.83f;
    public static int arkSeed = 3, arkOct = 2;
    public static float liqThresh = 0.64f, liqScl = 87f, redThresh = 5.1f, noArkThresh = 0.3f;
    public static int crystalSeed = 9, crystalOct = 2;
